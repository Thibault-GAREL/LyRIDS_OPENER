...
% KBS single-blind review: exact hardware disclosed (NVIDIA GTX 1660 Ti Max-Q, 6 GB VRAM).
...
\item[$\dagger$] OWNER reports $110$M for its BERT typing encoder. We count detection $+$ typing for parity with OPENER.
\end{tablenotes}
\end{threeparttable}
\end{adjustbox}
\end{table}
...
\zstr & 39.4$_{\pm2.1}$ & 48.7$_{\pm0.7}$ & \textbf{58.3$_{\pm0.3}$} & 49.2$_{\pm0.9}$ & 52.6$_{\pm0.2}$ & 28.8$_{\pm1.0}$ & 31.2$_{\pm0.2}$ & 36.0$_{\pm0.6}$ & 28.1$_{\pm0.3}$ & 34.7$_{\pm0.9}$ & 43.7$_{\pm1.1}^\dagger$ & 32.0$_{\pm0.7}$ & 30.7$_{\pm0.3}$ & 39.5$_{\pm0.1}$ \\
...
OPENER-Sup & 40.3$_{\pm0.2}$ & 48.7$_{\pm1.3}$ & 55.2$_{\pm0.8}$ & 49.1$_{\pm1.4}$ & 51.8$_{\pm1.7}$ & 24.8$_{\pm0.2}$ & \textbf{34.1$_{\pm0.9}$} & \textbf{37.8$_{\pm0.2}$} & \textbf{29.8$_{\pm0.5}$} & \textbf{35.9$_{\pm0.5}$} & 46.1$_{\pm2.1}^\dagger$ & 33.8$_{\pm0.1}$ & 34.0$_{\pm0.3}$ & \textbf{40.1$_{\pm0.5}$} \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
\footnotesize
...
\end{axis}
\end{tikzpicture}
\caption{End-to-end AMI per dataset (\autoref{tab:main}, OPENER curves show the three-seed means). \emph{Zero-shot} systems are drawn solid. OPENER-Sup is the dashed red line. $^\dagger$\,CoNLL-2003 (shaded) is in-domain for OWNER and OPENER. $^\ddagger$\,Qwen is evaluated on a $150$-sentence subsample per set.}
\label{fig:main}
\end{figure}
...
\zstr & 218 & 254 & 291 & 277 & 289 & 185 & 173 & 205 & 84 & 98 & 92 & 104 & 97 & 182 \\
% MOVED to architecture search (\autoref{tab:ablation}); preserved e2e per-dataset:
...
\zstr & 1.14 & 1.23 & 1.58 & 2.08 & 1.82 & 1.41 & 1.82 & 2.23 & 1.62 & 1.87 & 1.63 & 1.90 & 1.79 & 1.70 \\
% MOVED to architecture search (\autoref{tab:ablation}); preserved e2e per-dataset:
...
\zstr & 467M & 39.5$_{\pm0.1}$ & 182 & 1.70 & 0.10 \\
...
OPENER-Sup & 467M & 40.1$_{\pm0.5}$ & 143 & 1.59 & 0.09 \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
\footnotesize
...
\zstr & 46.1$_{\pm2.0}$ & 63.5$_{\pm2.3}$ & 67.0$_{\pm1.9}$ & 66.4$_{\pm1.2}$ & 59.6$_{\pm2.0}$ & 32.7$_{\pm2.8}$ & 47.3$_{\pm4.8}$ & 44.8$_{\pm1.1}$ & 33.9$_{\pm3.3}$ & 49.8$_{\pm0.3}$ & 70.7$_{\pm1.7}^\dagger$ & 41.5$_{\pm2.5}$ & 38.8$_{\pm1.6}$ & 50.9$_{\pm0.4}$ \\
\addlinespace
\multicolumn{15}{l}{\emph{Supervised (target labels)}} \\
% hard-mining 3k tr./2 ep. (recorded in project notes): 57.3 64.7 71.1 72.5 67.2 40.1 59.5 61.1 50.7 64.7 70.6 48.6 53.1 | 60.1
OPENER-Sup & \textbf{57.6$_{\pm0.9}$} & \textbf{66.0$_{\pm2.0}$} & \textbf{72.3$_{\pm1.5}$} & \textbf{73.6$_{\pm1.8}$} & \textbf{69.4$_{\pm2.2}$} & \textbf{38.8$_{\pm1.0}$} & \textbf{63.2$_{\pm2.0}$} & \textbf{67.7$_{\pm1.9}$} & \textbf{57.1$_{\pm2.0}$} & \textbf{69.2$_{\pm1.8}$} & 73.3$_{\pm1.6}^\dagger$ & \textbf{49.8$_{\pm0.6}$} & \textbf{51.5$_{\pm0.2}$} & \textbf{62.3$_{\pm1.0}$} \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
\footnotesize
