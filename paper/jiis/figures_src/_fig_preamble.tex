...
%
% Every figure body sits in a 160mm minipage (76mm, one column, for Fig7): this is the full text width
% of sn-jnl in its two-column (iicol) layout, so \linewidth keeps the
% exact meaning it had inside the figure* floats of the KBS version, and
% main.tex includes each PDF at its natural size.
% =====================================================================
