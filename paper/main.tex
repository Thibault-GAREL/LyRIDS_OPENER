...
% Notes (non rendues) :
% - ACM CCS : Computing methodologies > Artificial intelligence > Natural language
%   processing > Information extraction > Named entity recognition.
% - IEEE Taxonomy : l'IEEE publie chaque annee un PDF listant les mots-cles officiels ;
%   si la venue l'exige, remplacer les termes ci-dessous par des entrees de cette liste.
\begin{IEEEkeywords}
