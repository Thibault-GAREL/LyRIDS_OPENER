...
This yields a vector $e_i \in \mathbb{R}^{D}$ with $D$ truncatable in $\{768,512,256,128,64\}$. We keep the full $D{=}768$, which yields the best AMI (see \autoref{tab:ablation} for the full dimension sweep).
